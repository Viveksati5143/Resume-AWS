...
import cn from '@/images/logos/cn.png'
import Incloudo from '@/images/logos/incloudo.png'
import Isro from '@/images/logos/isro.png'
import dhslogo from '@/images/logos/dhslogo.png'
...
function Certificates() {
  let certificates = [
    {
      company: 'AWS Academy Cloud Architecting',
      title: 'AWS Academy',
      logo: aws,
      start: 'Aug, 2023',
    },
    {
      company: 'AWS Cloud Essentials',
      title: 'AWS Knowledge',
      logo: aws,
      start: 'May, 2023',
    },
    {
      company: 'CISCO Networking Essentials',
      title: 'CISCO',
      logo: Cisco,
      start: 'June, 2023',
    },
    {
      company: 'AI Foundations',
      title: 'IBM',
      logo: Ibm,
      start: 'Dec, 2021',
    },
      ...
      <Container className="mt-9">
        <div className="max-w-2xl">
          <h1 className="text-4xl font-bold tracking-tight text-zinc-800 sm:text-5xl dark:text-zinc-100">
            Hi there, I'm Vivek Sati
          </h1>
          <p className="mt-6 text-base text-zinc-600 dark:text-zinc-400">
            I’m a Cloud DevOps Engineer from India. I'm a firm believer in the value of continuous learning - 
            particularly in the constantly evolving field of technology and I'm excited to continue.
          </p>
          <a href="/src/pdf/VivekSatiResume.pdf" target="_blank" rel="noopener noreferrer">
            <button style={{ padding: '10px 20px', backgroundColor: '#4CAF50', color: 'white', border: 'none', borderRadius: '5px', marginTop: '20px' }}>
              View Resume
            </button>
          </a>
